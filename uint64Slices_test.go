...
func Test_Uint64FastShuffle(t *testing.T) {
	...
	for i := range shuffles {
		for j := range shuffles {
			...
			if yasup.Uint64Equals(shuffles[i], shuffles[j]) {
...
func Test_Uint64Equals(t *testing.T) {
	...
	for _, tc := range tcs {
		got := yasup.Uint64Equals(tc.a, tc.b)
		if got != tc.exp {
			t.Error(tc)
		}
	}
